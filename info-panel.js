AFRAME.registerComponent('info-panel', {
    init: function () {
        ...
        this.movieInfo = {
            ...
            mononokeButton: {
                title: 'Mononoke (1999)',
                imgEl: document.querySelector('#mononokeMovieImage'),
                description:
                    'A prince, in search of a cure, fights in a war between the forest and a mining colony. In this adventure he meets Mononoke.',
            },
            ponyoButton: {
                title: 'Ponyo (2003)',
